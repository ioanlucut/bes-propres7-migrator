...
export const Layer = {
  ...
  fromJSON(object: any): Layer {
    return {
      ...
      selectedTargetSetUuid: isSet(object.selectedTargetSetUuid)
        ...
        : undefined,
      effectsPresetUuid: isSet(object.effectsPresetUuid)
  ...
  fromPartial<I extends Exact<DeepPartial<Layer>, I>>(object: I): Layer {
    ...
    message.selectedTargetSetUuid =
      object.selectedTargetSetUuid !== undefined &&
      object.selectedTargetSetUuid !== null
        ? UUID.fromPartial(object.selectedTargetSetUuid)
        : undefined;
    message.effectsPresetUuid =
      object.effectsPresetUuid !== undefined &&
    ...
    message.layerPresetUuid =
      object.layerPresetUuid !== undefined && object.layerPresetUuid !== null
...
export const Layer_Blending = {
  encode(
    message: Layer_Blending,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    if (message.standard !== undefined) {
      Layer_Blending_Standard.encode(
        message.standard,
        writer.uint32(10).fork(),
      ).ldelim();
    }
    if (message.matte !== undefined) {
      Layer_Blending_Matte.encode(
        message.matte,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.standard = Layer_Blending_Standard.decode(
            reader,
            reader.uint32(),
          );
          continue;
  ...
  fromJSON(object: any): Layer_Blending {
    return {
      standard: isSet(object.standard)
        ? Layer_Blending_Standard.fromJSON(object.standard)
        : undefined,
      matte: isSet(object.matte)
        ? Layer_Blending_Matte.fromJSON(object.matte)
        : undefined,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Layer_Blending>, I>>(
    ...
    message.standard =
      object.standard !== undefined && object.standard !== null
        ...
        : undefined;
    message.matte =
      object.matte !== undefined && object.matte !== null
...
export const Layer_Blending_Standard = {
  encode(
    message: Layer_Blending_Standard,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    if (message.mode !== 0) {
...
export const Layer_Blending_Matte = {
  encode(
    message: Layer_Blending_Matte,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    if (message.alpha !== undefined) {
      Layer_Blending_Matte_Alpha.encode(
        message.alpha,
        writer.uint32(10).fork(),
      ).ldelim();
    }
    if (message.luma !== undefined) {
      Layer_Blending_Matte_Luma.encode(
        message.luma,
        writer.uint32(18).fork(),
      ).ldelim();
    }
    if (message.white !== undefined) {
      Layer_Blending_Matte_White.encode(
        message.white,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.alpha = Layer_Blending_Matte_Alpha.decode(
            reader,
            reader.uint32(),
          );
          continue;
        case 2:
          ...
          message.luma = Layer_Blending_Matte_Luma.decode(
            reader,
            reader.uint32(),
          );
          continue;
        case 4:
          ...
          message.white = Layer_Blending_Matte_White.decode(
            reader,
            reader.uint32(),
          );
          continue;
  ...
  fromJSON(object: any): Layer_Blending_Matte {
    return {
      alpha: isSet(object.alpha)
        ? Layer_Blending_Matte_Alpha.fromJSON(object.alpha)
        : undefined,
      luma: isSet(object.luma)
        ? Layer_Blending_Matte_Luma.fromJSON(object.luma)
        : undefined,
      white: isSet(object.white)
        ? Layer_Blending_Matte_White.fromJSON(object.white)
        : undefined,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Layer_Blending_Matte>, I>>(
    ...
    message.alpha =
      object.alpha !== undefined && object.alpha !== null
        ...
        : undefined;
    message.luma =
      object.luma !== undefined && object.luma !== null

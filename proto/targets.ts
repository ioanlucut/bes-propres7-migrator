...
import {
  ...
  graphics_Element_FlipModeFromJSON,
  graphics_Element_FlipModeToJSON,
  Graphics_Rect,
  Graphics_Size,
  Media,
} from './graphicsData';
...
export const TargetSet = {
  ...
  fromJSON(object: any): TargetSet {
    return {
      ...
      testImagePath: isSet(object.testImagePath)
        ? URL.fromJSON(object.testImagePath)
        : undefined,
      sourceSize: isSet(object.sourceSize)
        ? Graphics_Size.fromJSON(object.sourceSize)
        : undefined,
      targets: Array.isArray(object?.targets)
        ? object.targets.map((e: any) => Target.fromJSON(e))
        : [],
      testPattern: isSet(object.testPattern)
        ? TestPattern.fromJSON(object.testPattern)
        : undefined,
    };
  },
  ...
  toJSON(message: TargetSet): unknown {
    ...
    message.testImagePath !== undefined &&
      (obj.testImagePath = message.testImagePath
        ? URL.toJSON(message.testImagePath)
        : undefined);
    message.sourceSize !== undefined &&
      (obj.sourceSize = message.sourceSize
        ? Graphics_Size.toJSON(message.sourceSize)
        : undefined);
    if (message.targets) {
    ...
    message.testPattern !== undefined &&
      (obj.testPattern = message.testPattern
        ? TestPattern.toJSON(message.testPattern)
        : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<TargetSet>, I>>(
    object: I,
  ): TargetSet {
    const message = createBaseTargetSet();
    message.uuid =
    ...
    message.color =
      object.color !== undefined && object.color !== null
        ...
        : undefined;
    message.testImagePath =
      object.testImagePath !== undefined && object.testImagePath !== null
        ? URL.fromPartial(object.testImagePath)
        : undefined;
    message.sourceSize =
      object.sourceSize !== undefined && object.sourceSize !== null
...
export const Target = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.sourceUnitRect = Graphics_Rect.decode(
            reader,
            reader.uint32(),
          );
          continue;
  ...
  fromJSON(object: any): Target {
    return {
      uuid: isSet(object.uuid) ? UUID.fromJSON(object.uuid) : undefined,
      name: isSet(object.name) ? String(object.name) : '',
      sourceUnitRect: isSet(object.sourceUnitRect)
        ? Graphics_Rect.fromJSON(object.sourceUnitRect)
        : undefined,
      testImageFill: isSet(object.testImageFill)
        ? Media.fromJSON(object.testImageFill)
        : undefined,
      shape: isSet(object.shape)
        ? Graphics_Element.fromJSON(object.shape)
        : undefined,
  ...
  toJSON(message: Target): unknown {
    ...
    message.sourceUnitRect !== undefined &&
      (obj.sourceUnitRect = message.sourceUnitRect
        ? Graphics_Rect.toJSON(message.sourceUnitRect)
        : undefined);
    message.testImageFill !== undefined &&
      (obj.testImageFill = message.testImageFill
        ? Media.toJSON(message.testImageFill)
        : undefined);
    message.shape !== undefined &&
      (obj.shape = message.shape
        ? Graphics_Element.toJSON(message.shape)
        : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<Target>, I>>(object: I): Target {
    ...
    message.name = object.name ?? '';
    message.sourceUnitRect =
      object.sourceUnitRect !== undefined && object.sourceUnitRect !== null
        ? Graphics_Rect.fromPartial(object.sourceUnitRect)
        : undefined;
    message.testImageFill =
      object.testImageFill !== undefined && object.testImageFill !== null

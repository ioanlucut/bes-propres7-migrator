...
export const Template_Slide = {
  ...
  create<I extends Exact<DeepPartial<Template_Slide>, I>>(base?: I): Template_Slide {
...
export const Template_Document = {
  ...
  create<I extends Exact<DeepPartial<Template_Document>, I>>(base?: I): Template_Document {

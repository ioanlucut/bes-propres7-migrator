...
export const ProPresenterWorkspace = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.proScreens.push(
            ProPresenterScreen.decode(reader, reader.uint32()),
          );
          continue;
        case 2:
          if (tag !== 18) {
        ...
        case 6:
          ...
          message.stageLayoutMappings.push(
        ...
        case 7:
          ...
          message.audioSettings = Audio_SettingsDocument.decode(
            reader,
            reader.uint32(),
          );
          continue;
        ...
        case 9:
          ...
          message.recordSettings = Recording_SettingsDocument.decode(
            reader,
            reader.uint32(),
          );
          continue;
  ...
  fromJSON(object: any): ProPresenterWorkspace {
    return {
      ...
      stageLayoutMappings: globalThis.Array.isArray(object?.stageLayoutMappings)
        ...
        : [],
      audioSettings: isSet(object.audioSettings)
  ...
  fromPartial<I extends Exact<DeepPartial<ProPresenterWorkspace>, I>>(
    ...
    const message = createBaseProPresenterWorkspace();
    message.proScreens =
      object.proScreens?.map((e) => ProPresenterScreen.fromPartial(e)) || [];
    message.audienceLooks =
      object.audienceLooks?.map((e) => ProAudienceLook.fromPartial(e)) || [];
    message.liveAudienceLook =
    ...
    message.videoInputs =
      object.videoInputs?.map((e) => VideoInput.fromPartial(e)) || [];
    message.stageLayoutMappings =
      object.stageLayoutMappings?.map((e) =>
        Stage_ScreenAssignment.fromPartial(e),
      ) || [];
    message.audioSettings =
      object.audioSettings !== undefined && object.audioSettings !== null
        ? Audio_SettingsDocument.fromPartial(object.audioSettings)
        : undefined;
    message.selectedLibraryName = object.selectedLibraryName ?? '';
    message.recordSettings =
      object.recordSettings !== undefined && object.recordSettings !== null
    ...
    message.digitalAudioSetup =
      ...
      object.digitalAudioSetup !== null
        ...
        : undefined;
    message.audioInputs =
      object.audioInputs?.map((e) => AudioInput.fromPartial(e)) || [];

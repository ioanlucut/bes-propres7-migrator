    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.libraryChildren = Library_LibraryArray.decode(
            reader,
            reader.uint32(),
          );
          continue;
        case 3:
          ...
          message.libraryItems = Library_LibraryItems.decode(
            reader,
            reader.uint32(),
          );
          continue;
  ...
  fromJSON(object: any): Library {
    return {
      ...
      libraryChildren: isSet(object.libraryChildren)
        ...
        : undefined,
      libraryItems: isSet(object.libraryItems)
        ? Library_LibraryItems.fromJSON(object.libraryItems)
        : undefined,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Library>, I>>(object: I): Library {
    ...
    message.url =
      object.url !== undefined && object.url !== null
        ...
        : undefined;
    message.libraryChildren =
      object.libraryChildren !== undefined && object.libraryChildren !== null
        ? Library_LibraryArray.fromPartial(object.libraryChildren)
        : undefined;
    message.libraryItems =
      object.libraryItems !== undefined && object.libraryItems !== null
